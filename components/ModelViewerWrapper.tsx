...
export const ModelViewerWrapper: React.FC<ModelViewerProps> = ({ src, poster, alt }) => {
  ...
  return (
    <div className="w-full h-full bg-slate-100 rounded-xl overflow-hidden relative group">
      ...
      >
        <div slot="ar-button" className="absolute bottom-4 right-4 bg-indigo-600 text-white px-4 py-2 rounded-full font-medium shadow-lg cursor-pointer hover:bg-indigo-700 transition-colors flex items-center gap-2 z-10">
